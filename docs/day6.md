...
### 5. Mejora de Cobertura de Pruebas
Se añadieron pruebas exhaustivas para los módulos CLI y TUI, alcanzando una cobertura total de más del 80% para todo el proyecto.
...
- Preparar la versión beta v0.9.0-beta 